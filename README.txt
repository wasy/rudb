...
3. Хлам с птр и тестов пока не дропался, поэтому сами делаете сверку с идентификаторами на 
последней ревизии основной базы и удаляете не нужные.

4. Начальные данные брались с версии 3.3.5а, путем выполняя запросов...
Пример:
SELECT
